...
/* harmony import */ var _components_user_register_user_register_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./components/user-register/user-register.component */ "./src/app/components/user-register/user-register.component.ts");
...
/* harmony import */ var _services_register_user_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./services/register-user.service */ "./src/app/services/register-user.service.ts");
/* harmony import */ var _components_user_register_user_register_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./components/user-register/user-register.component */ "./src/app/components/user-register/user-register.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
        declarations: [
            ...
            _components_user_register_user_register_component__WEBPACK_IMPORTED_MODULE_11__["UserRegisterComponent"]
        ],
        imports: [
        ...
        providers: [
            _services_register_user_service__WEBPACK_IMPORTED_MODULE_10__["RegisterUserService"]
        ],
...
let UserRegisterComponent = class UserRegisterComponent {
    constructor(usrServices, formBuilder) {
    ...
    getUsrRegisterInfo() {
        this.usrServices.getInfoRegisterRoute().subscribe(res => {
            this.routes = res[0],
                this.colleges = res[1],
                this.campus = res[2],
    ...
    onRegister() {
        ...
        this.usrServices.saveNewUserRoute(this.user).subscribe(res => {
...
UserRegisterComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./user-register.component.css */ "./src/app/components/user-register/user-register.component.css")).default]
    })
...
module.exports = __webpack_require__(/*! C:\Users\Rodrigo\Documents\GitHub\BlueGo_App\client-BlueGo2\src\main.ts */"./src/main.ts");
